...
//   var options = {
//     // url: 'https://d909e2e0120d0bcbd2ef795dd19eb2e97c2f8d78d8ebb6d4:856371fe6a97e8be8fed6ab14c95b4832f82d1d3116cb17e@api.exotel.in/v1/Accounts/sveltosetechnologies2/Calls/${Sid}.json'
//     url: `https://${key}:${token}@api.exotel.in/v1/Accounts/${sid}/Calls/${Sid}.json`
//   }
//   //console.log("options",options)
//   function callback(error, response, body) {
//     if (response) {
